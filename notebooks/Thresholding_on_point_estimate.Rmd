...
The first figure shows the distribution of estimated differences between the two populations, with each plot showing the results with a different sd for the populations. As you would expect, increasing the number of replicates and decreasing the sd leads to more accurate estimates of the true difference (0.4).
