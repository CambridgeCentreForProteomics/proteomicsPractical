...
TTest_results_annotated <- merge(human_proteins_ids_df, TTest_results, by.x="UniprotID", by.y="master_protein", all.y=TRUE)


# we'll write the results out to file so they can be further interogated outside this notebooks
